...
ros2 launch susumu_object_perception simulation.launch.py \
  map:=/home/taro/ros2_ws/src/susumu_object_perception/outputs/mapping_indoor/house.yaml \
...
`outputs/mapping_outdoor/village_square_trimmed_gt.yaml` / `outputs/mapping_outdoor/village_park_trimmed_gt.yaml` は world 由来の正解データ。
